...
//编译
int FramelessWindow::on_compileAction_triggered()
{
    this->console->clear();
...
void FramelessWindow::on_sendData(){
...
//编译并执行
void FramelessWindow::on_compileAndRunAction_triggered()
{
    this->console->clear();
...
// debug
void FramelessWindow::on_debugAction_triggered(){
    dmw.show();

}

void FramelessWindow::on_beginDebug(){
    this->console->clear();
    cmdProcess = new QProcess(this);//新建进程
    connect(cmdProcess , SIGNAL(readyReadStandardOutput()) , this , SLOT(on_readoutput()));//绑定得到输出槽函数
    connect(cmdProcess , SIGNAL(readyReadStandardError()) , this , SLOT(on_readerror()));//绑定发生错误槽函数
...
void FramelessWindow::on_nextMove(){
